<script lang="ts">
	...
	let {
		...
		example?: 'ide' | 'horizontal' | 'vertical' | 'sizeEnd' | 'code';
...
<div class="w-full max-w-4xl space-y-3">
	<div class="space-y-1">
		...
		<p class="text-xs text-secondary">
			Arrastra el handle, o haz clic en él y usa las flechas. También puedes anidar paneles
			horizontales y verticales.
		</p>
	</div>

	{#if example === 'ide'}
		<div class="h-[28rem] overflow-hidden rounded-xl border border-border shadow-sm">
			<SplitPane
				orientation="horizontal"
				bind:size={sidebar}
				minSize={18}
	...
	{:else if example === 'horizontal'}
		<div class="h-64 overflow-hidden rounded-xl border border-border">
			<SplitPane
				{orientation}
				bind:size={simple}
				{minSize}
	...
	{:else if example === 'vertical'}
		<div class="h-80 overflow-hidden rounded-xl border border-border">
			<SplitPane
				orientation="vertical"
				bind:size={simple}
				minSize={20}
	...
	{:else}
		<div class="h-[26rem] overflow-hidden rounded-xl border border-border shadow-sm">
			<SplitPane
				orientation="horizontal"
				bind:size={explorer}
				minSize={16}
